...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image: "/projects/portfolio-webapp.png",
    screenshots: [
      { src: "/projects/portfolio-webapp.png", caption: "Homepage — Portfolio hero section with project showcase", orientation: "landscape" },
    ],
    category: "Next.js",
    tech: ["Tailwind CSS", "Framer Motion", "Vercel"],
    links: {
      github: "https://github.com/bolajidavid25/Bolaji-Portfolio",
      live: "https://bolajidavid.dev",
    },
    featured: true,
  },
  {
    ...
    image: "/projects/await-apartment.png",
    screenshots: [
      { src: "/projects/await-apartment.png", caption: "Landing Page — Premium real estate showcase with property listings", orientation: "landscape" },
    ],
    category: "React",
    tech: ["React", "Tailwind CSS", "Framer Motion"],
    links: {
      github: "https://github.com/bolajidavid25/Await-Apartment-",
      live: "https://awaitapartment.vercel.app/",
    },
    featured: true,
  },
  {
  ...
  {
    slug: "noir-fashion-store",
    title: "Noir Fashion Store",
    summary:
      "Luxury fashion storefront built with React, TypeScript, and Vite featuring product browsing, cart management, checkout, and AI-powered fashion assistant.",
    problem:
      "Fashion brands need a premium digital presence that showcases products elegantly while providing seamless shopping experiences and personalized assistance.",
    solution:
      "Built a luxury fashion e-commerce platform with React 19, TypeScript, Firebase authentication, Firestore, Stripe checkout, and integrated Onyx AI virtual assistant for fashion tips and personalized recommendations.",
    features: [
      "Product browsing with elegant gallery",
      "Cart management and checkout flow",
      "Firebase authentication and user accounts",
      "Stripe sandbox checkout integration",
      "Resend-powered email notifications",
      "Onyx AI virtual assistant for fashion tips and recommendations",
    ],
    preview: "Luxury fashion storefront with premium product display, seamless checkout, and AI-powered fashion assistant.",
    image: "/projects/noir-fashion-store.png",
    screenshots: [
      { src: "/projects/noir-fashion-store.png", caption: "Homepage — Premium fashion showcase with elegant product display", orientation: "landscape" },
      { src: "/projects/noir-gown.jpg", caption: "Product Detail — Luxury gown with detailed specifications", orientation: "portrait" },
      { src: "/projects/noir-gown-blue.jpg", caption: "Product Variant — Blue gown color option", orientation: "portrait" },
    ],
    category: "React",
    tech: ["React 19", "TypeScript", "Vite", "Firebase", "Stripe", "Resend", "AI Integration"],
    links: {
      github: "https://github.com/bolajidavid25/Noir",
      live: "https://noir-fashion-store.vercel.app/",
    },
    featured: true,
  },
];
